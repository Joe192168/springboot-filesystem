package com.geominfo.framework.aspectj;
...
import com.geominfo.common.enums.BusinessStatus;
import com.geominfo.common.enums.HttpMethod;
        ...
        if (paramsArray != null && paramsArray.length > 0) {
            for (Object o : paramsArray) {
                if (StringUtils.isNotNull(o) && !isFilterObject(o)) {
                    try {
                        String jsonObj = JSONObject.toJSONString(o, excludePropertyPreFilter());
